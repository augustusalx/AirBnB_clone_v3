#!/usr/bin/python3
"""
Here contains the TestAmenityDocs classes
...
class TestAmenityDocs(unittest.TestCase):
    ...
    def test_amenity_module_docstring(self):
        """A test for the amenity.py module docstring"""
...
class TestAmenity(unittest.TestCase):
    ...
    def test_to_dict_values(self):
        """test that values in the dict returned from to_dict are correct"""
