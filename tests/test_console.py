...
class TestConsoleDocs(unittest.TestCase):
    """The lass for testing documentation of the console"""
    ...
    def test_pep8_conformance_test_console(self):
        """A Test that tests/test_console.py conforms to PEP8."""
        pep8s = pep8.StyleGuide(quiet=True)
...
class TestConsoleCommands(unittest.TestCase):
    """The test console commands"""
    @classmethod
    def setUpClass(cls):
        """Will create command console for test"""
    ...
    def tearDown(self):
        """A close in memory buffer after test completes"""
        self.output.close()

    @unittest.skipIf(os.getenv('HBNB_TYPE_STORAGE') == 'db',
                     "Testing DBStorage")
    def test_do_create(self):
        """To test do_create method of console"""
